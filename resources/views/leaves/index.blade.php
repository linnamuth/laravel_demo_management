...
<div class="row">
    <div class="col-lg-12 margin-tb mb-4">
        <div class="pull-left">
            <h4>Leave Requests
                <div class="float-end">
                    <a class="btn" style="background-color: #3b94f3;color:white"  href="{{ route('leave-request.create') }}"> Request Leave</a>
                </div>
            </h4>
        </div>
    </div>
            ...
            @foreach ($leaveRequests as $leaveRequest)
                <tr>
                    ...
                    <td>
                        ...
                        @if (isset($approvalStatus['hr manager']) && isset($approvalStatus['team leader']) && isset($approvalStatus['cfo']))
                            @if ($approvalStatus['hr manager'] === 'approved' && $approvalStatus['team leader'] === 'approved' && $approvalStatus['cfo'] === 'approved')
                    ...
                    <td>
                        @if (Auth::user()->role->name === 'hr manager' || Auth::user()->role->name === 'team leader' || Auth::user()->role->name === 'cfo')
